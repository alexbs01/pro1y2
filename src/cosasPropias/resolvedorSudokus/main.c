...
int main() {
    ...
    int numero[COLUMNAS];
    tCasillas casilla[COLUMNAS][FILAS];
    ...
    for(int j = 0; j < FILAS; j++) {
        ...
        // La fila almacenada en la variable "linea", se descompone en 9 numeros que se guardan en las 9 posiciones del array "numero"
